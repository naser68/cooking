...
public class Dessert extends Fragment {
    ...
    private Dessert.OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cookings = request.GetCookings(3);
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onDessertFragmentInteraction(uri);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onDessertFragmentInteraction(Uri uri);
    }
}
